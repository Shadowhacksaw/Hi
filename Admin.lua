...
local Window = Rayfield:CreateWindow({
   ...
   Name = "admin c00lhackk script hub l also this is like early access one but better",

   Icon = 9, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).

   LoadingTitle = "admin c00lhackk script hub",
...
local Tabaccess = Window:CreateTab("early access to script hub", 44832458) -- Title, Image
...
Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Shadowhacksaw/Hi/refs/heads/main/Admin.lua"))()
...
local Button = Tabaccess:CreateButton({

Name = "early access to script hub",

Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Shadowhacksaw/Hi/refs/heads/main/test.lua"))()
