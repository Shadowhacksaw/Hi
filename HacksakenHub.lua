...
local Tab5 = Window:CreateTab("Remove effects", 130695581754590)
local Tab6 = Window:CreateTab("Bypass", 130695581754590)
...
local oldHair = survivor:FindFirstChild("NoclipDetector")
if oldHair then
	oldHair:Destroy()
   end,
}) 
local Button = Tab6:CreateButton({
Name = "Noclip bypasser (007n7)"
Callback = function() 
local survivor = workspace:WaitForChild("Players"):WaitForChild("Survivors"):WaitForChild("007n7")
local Noc = survivor:FindFirstChild("NoclipDetector")
if Noc then
	Noc:Destroy()
   end,
})
local Button = Tab6:CreateButton({
Name = "Noclip bypasser (Taph)"
Callback = function() 
local survivor = workspace:WaitForChild("Players"):WaitForChild("Survivors"):WaitForChild("Taph")
local Sub = survivor:FindFirstChild("NoclipDetector")
if Sub then
	Sub:Destroy()
   end,
}) 
local Button = Tab6:CreateButton({
Name = "Noclip bypasser (Guest1337)"
Callback = function() 
local survivor = workspace:WaitForChild("Players"):WaitForChild("Survivors"):WaitForChild("Guest1337")
local Po = survivor:FindFirstChild("NoclipDetector")
if Po then
	Po:Destroy()
   end,
}) 
