...
-----------------------------------------------------------------------------------------
local owners = {"Min3rZ3roAqua89"} -- Are able to set admins who can ban/etc... using :pa name
local admins = {"pizzahexl"} -- Sets admins who can use ban/kick/admin or shutdown
local tempadmins = {} -- Sets admins who can't use ban/kick/admin or shutdown
local banland = {"pizzahexl"} -- Permanently Bans people
